...
//    }
    ...
    public void assertElementPresent() {
        ...
        //Хоть проверка и мнгновенна, элемент еще не успевает отобразиться на странице.
        //Как провести проверку элемента до прогрузки я не нашел
        waitForElementPresent(
                By.id("org.wikipedia:id/view_page_title_text"),
                "Cannot fiend article title", 0);
